                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-gray-50 dark:bg-gray-700/50 border-b border-gray-100 dark:border-gray-700">
                                    <th class="px-6 py-4 font-bold text-sm uppercase tracking-wider text-gray-600 dark:text-gray-400">No</th>
                                    <th class="px-6 py-4 font-bold text-sm uppercase tracking-wider text-gray-600 dark:text-gray-400">Nama</th>
                                    <th class="px-6 py-4 font-bold text-sm uppercase tracking-wider text-gray-600 dark:text-gray-400">Email</th>
                                    <th class="px-6 py-4 font-bold text-sm uppercase tracking-wider text-gray-600 dark:text-gray-400">Phone</th>
                                    <th class="px-6 py-4 font-bold text-sm uppercase tracking-wider text-gray-600 dark:text-gray-400 text-right">Aksi</th>
                                </tr>
                            </thead>
                                    ...
                                    <tr class="hover:bg-gray-50/80 dark:hover:bg-gray-700/30 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="h-10 w-10 flex-shrink-0 rounded-full bg-indigo-100 dark:bg-indigo-900/40 flex items-center justify-center text-indigo-700 dark:text-indigo-400 font-bold text-lg">
                                    ...
                                    <tr>
                                        <td colspan="5" class="px-6 py-10 text-center text-gray-500 dark:text-gray-400">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <p class="text-sm">Klik tombol di atas untuk menambahkan client baru.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse
